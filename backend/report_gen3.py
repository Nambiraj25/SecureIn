...
def generate_pentest_report(csv_path, output_file="pentest_report.pdf"):
    ...
    doc.build(content)
    print(f"Enhanced PDF report generated: {output_file}")

# Usage
generate_pentest_report("results.csv")